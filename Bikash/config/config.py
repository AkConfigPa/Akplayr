...
BOT_ID = int(getenv("BOT_ID", "7004925953"))
BOT_TOKEN = getenv("BOT_TOKEN")
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID"))
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "🇦𝐊 🇲𝐔𝐒𝐈𝐂🇧𝐎𝐓")
OWNER_ID = list(map(int, getenv("OWNER_ID", "1832348805").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/AkConfigPa/Akplayr")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "AkConfigPaid")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/AkConfigPaid_2")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+wO6vTB_ozmYzOWU1")
